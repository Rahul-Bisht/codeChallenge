...
app.controller('locations',['$scope','$location',function(scope,$location){
    scope.category=[];
    scope.subCategory=[];
    scope.goToCategory=function(parentIndex,childIndex){
        var loc=scope.location[parentIndex];
        scope.category=loc.branches[childIndex].categories;
